package io.trtc.tuikit.chat.uikit.components.videorecorder.utils;
...
public class VideoRecorderPermissionHelper {
    ...
    public static void requestPermission(@PermissionType int type, PermissionCallback callback) {
        ...
        ApplicationInfo applicationInfo = ContextProvider.getApplicationContext().getApplicationInfo();
        int permissionIcon = 0;
        CharSequence labelCharSequence = applicationInfo.loadLabel(ContextProvider.getApplicationContext().getPackageManager());
        String appName = "App";
        ...
        switch (type) {
            ...
            case PERMISSION_STORAGE: {
                ...
                permissionIcon = R.drawable.video_recorder_permission_icon_file;
                break;
            }
            default:
                break;
