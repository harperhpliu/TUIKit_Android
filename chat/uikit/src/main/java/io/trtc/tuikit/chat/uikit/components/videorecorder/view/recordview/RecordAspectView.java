...
public class RecordAspectView extends RelativeLayout {
    ...
    private void initView() {
        ...
        mImageAspectCurr = findViewById(R.id.video_recorder_aspect_icon);
        ((TextView)findViewById(R.id.video_recorder_aspect_title)).setText(R.string.video_recorder_aspect);
