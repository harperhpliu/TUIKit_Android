...
public class TransformLayout extends RelativeLayout implements View.OnTouchListener {

    private final String TAG = TransformLayout.class.getSimpleName() + "_" + hashCode();
    ...
    public void enableTransform(boolean enable) {
        Log.i(TAG, enable ? "enable " : "disable " + "transform.");
    ...
    private void adjustContentToLimitRect() {
        Log.i(TAG,"adjust content to limit rect.");
