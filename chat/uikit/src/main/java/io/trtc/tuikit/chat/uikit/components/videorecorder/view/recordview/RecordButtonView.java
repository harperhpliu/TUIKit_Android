...
public class RecordButtonView extends RelativeLayout implements View.OnTouchListener {
    ...
    private void initViews() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.video_recorder_start_record_button,
                this, true);
        mButtonOuterProgressRingView = rootView.findViewById(R.id.video_recorder_record_button_ring_progress_bar);
        mButtonOuterProgressRingView.setVisibility(VISIBLE);

        super.setOnTouchListener(this);

        mButtonInnerView = findViewById(R.id.video_recorder_record_button_inner_circle);
    }
    ...
    private void startTakePhotoAnim() {
        ViewGroup rootLayout = findViewById(R.id.video_recorder_compose_record_btn);
