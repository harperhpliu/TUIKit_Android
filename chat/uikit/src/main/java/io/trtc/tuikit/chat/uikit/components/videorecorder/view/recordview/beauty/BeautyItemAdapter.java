...
public class BeautyItemAdapter extends BeautyScrollViewAdapter {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, Context context) {
            ...
            root = itemView;
            icon = itemView.findViewById(R.id.video_recorder_beauty_icon);
            title = itemView.findViewById(R.id.video_recorder_beauty_title);
            background = itemView.findViewById(R.id.video_recorder_beauty_select_background);
        }
