package io.trtc.tuikit.chat.uikit.components.videorecorder.config;
public class VideoRecorderConstants {
    ...
    public static final String RESULT_NAME_RECORD_TYPE = "recordType";
    public static final String RESULT_NAME_RECORD_DURATION = "recordDuration";
